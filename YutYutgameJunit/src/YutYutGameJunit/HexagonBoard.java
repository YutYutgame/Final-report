...
public class HexagonBoard extends Board{
   ...
   private int base_x=370, base_y=450, p_idx=0;
    private List<Point> hexagonPoints = new ArrayList<>(49);
    ...
    protected void initNodes() {
        ...
        for (; p_idx < 5 ;p_idx++) {
           nodes.put(p_idx, new BoardNode(p_idx, new Point(base_x, base_y), false));
            base_x+=30;
            base_y-=40;
        }
        ...
        //중앙
        base_x=260; base_y=250;
       nodes.put(p_idx, new BoardNode(p_idx, new Point(base_x, base_y), true));
       p_idx++;
