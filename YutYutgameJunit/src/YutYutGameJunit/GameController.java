...
import static YutYutGame.Board.getAllCarriedPieces;

public class GameController {
    private final Board board;
    private List<Player> players; //junit test 추가
    private int currentPlayerIndex = 0; //junit-test 추가


    public GameController(Board board) {
        this.board = board;
    }
    public GameController(List<Player> players, Board board) { //junit test로 추가
    ...
    public MoveResult movePiece(Piece piece, int steps) {
        ...
        piece.addDistanceMoved(count); // count는 steps의 절댓값
